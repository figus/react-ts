...
exports.fetch_regex = /^\/api\/type2\/(.*)$/; // The URL to look for when parsing the request.
...
exports.cluster_process_count = 1; //Number(process.env.CLUSTER_PROCESS_COUNT) || require("os").cpus().length;
